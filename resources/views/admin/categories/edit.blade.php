...
<body>
    <div class="container">
      <div class="card">
        ...
        <div class="card-body">
          <form class="needs-validation" action="{{ route('admin.categories.update',$category->id)}}" method="POST" novalidate>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4 mb-3">
                   ...
                   <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom02" name="codigo" value="{{$category->codigo}}" required>
                    <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
